...
(async () => {
    ...
    try {
        ...
        logger.info('Starting notification server...', withLogMetadata_1.withLogMetadata('runtime', 'microservice/notification'));
        ...
        server.listen(configuration.portOrSocket, () => {
            logger.info('Started notification server.', withLogMetadata_1.withLogMetadata('runtime', 'microservice/notification', {
        ...
        logger.fatal('An unexpected error occured.', withLogMetadata_1.withLogMetadata('runtime', 'microservice/notification', { error: ex }));
        process.exit(1);
    }
})();
