...
const validateDomainEventHandler = function ({ domainEventHandler }: {
  ...
  if (!isUndefined(domainEventHandler.getDocumentation)) {
  ...
  if (!isUndefined(domainEventHandler.getSchema)) {
