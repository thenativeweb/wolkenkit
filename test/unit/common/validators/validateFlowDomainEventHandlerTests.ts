...
suite('validateFlowDomainEventHandler', (): void => {
  ...
  test('throws an error if the given domain event handler is not an object.', async (): Promise<void> => {
    ...
    }).is.throwing((ex): boolean => (ex as CustomError).code === 'EFLOWDOMAINEVENTHANDLERMALFORMED' && ex.message === `Property 'domainEventHandler' is not an object.`);
  });
  ...
  test('throws an error if is relevant is missing.', async (): Promise<void> => {
    ...
    }).is.throwing((ex): boolean => (ex as CustomError).code === 'EFLOWDOMAINEVENTHANDLERMALFORMED' && ex.message === `Function 'isRelevant' is missing.`);
  });
  ...
  test('throws an error if is relevant is not a function.', async (): Promise<void> => {
    ...
    }).is.throwing((ex): boolean => (ex as CustomError).code === 'EFLOWDOMAINEVENTHANDLERMALFORMED' && ex.message === `Property 'isRelevant' is not a function.`);
  });
  ...
  test('throws an error if handle is missing.', async (): Promise<void> => {
    ...
    }).is.throwing((ex): boolean => (ex as CustomError).code === 'EFLOWDOMAINEVENTHANDLERMALFORMED' && ex.message === `Function 'handle' is missing.`);
  });
  ...
  test('throws an error if handle is not a function.', async (): Promise<void> => {
    ...
    }).is.throwing((ex): boolean => (ex as CustomError).code === 'EFLOWDOMAINEVENTHANDLERMALFORMED' && ex.message === `Property 'handle' is not a function.`);
  });
});
