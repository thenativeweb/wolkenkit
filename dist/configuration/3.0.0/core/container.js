...
var container = function container(_ref) {
  ...
  var result = {
    dependsOn: ["".concat(configuration.application.name, "-mongodb"), "".concat(configuration.application.name, "-node-modules"), "".concat(configuration.application.name, "-postgres"), "".concat(configuration.application.name, "-rabbitmq")],
    image: "".concat(configuration.application.name, "-core"),
    name: "".concat(configuration.application.name, "-core"),
