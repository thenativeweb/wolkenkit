...
var container = function container(options) {
  ...
  var result = {
    dependsOn: [configuration.application + '-mongodb', configuration.application + '-node-modules', configuration.application + '-postgres', configuration.application + '-rabbitmq'],
