...
function () {
  ...
  _regenerator.default.mark(function _callee(_ref, progress) {
    var configuration, dangerouslyDestroyData, directory, env, existingContainers, dangerouslyExposeHttpPorts, debug, persistData, sharedKey, applicationStatus;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            configuration = _ref.configuration, dangerouslyDestroyData = _ref.dangerouslyDestroyData, directory = _ref.directory, env = _ref.env;
