                ...
                return _regenerator.default.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        args = ['-nNT', '-L', "".concat(addresses.from.port, ":").concat(addresses.from.host, ":").concat(addresses.to.port), "".concat(username, "@").concat(addresses.server.host), '-p', "".concat(addresses.server.port)];
