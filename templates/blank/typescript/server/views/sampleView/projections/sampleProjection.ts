import { DomainEvent, ProjectionHandler } from 'wolkenkit';
...
export const sampleProjection: ProjectionHandler<SampleViewItem[], SampleDomainEventData> = {
  ...
  async handle (sampleViewItems: SampleViewItem[], domainEvent: DomainEvent<SampleDomainEventData>): Promise<void> {
